...
const FANTASY_TEXT_PL: Readonly<Record<string, string>> = {
  ...
  "unit_type.sam_launcher": "Wieża antymagiczna",
  ...
  // Kolej z bazowej gry to w Dzikich Ziemiach drogi i karawany kupieckie.
  "chat.misc.build_closer": "Buduj bliżej, a zdobędziesz karawany!",
  "help_modal.build_factory": "Kuźnia",
  "help_modal.build_factory_desc":
    "Automatycznie wytycza drogi do pobliskich twierdz, przystani i innych kuźni, a także może łączyć się z przyjaznymi sąsiadami. Karawany ruszają regularnie i dają stałą ilość złota za każdy odwiedzony budynek na trasie, z dodatkowym złotem za odwiedzanie budynków sąsiadów.",
...
const PL_SUPPLEMENT: Readonly<Record<string, string>> = {
  ...
  "game_info_modal.train_trade": "Karawana kupiecka",
  ...
  "graphics_setting.rail_distance_desc":
    "Jak daleko po oddaleniu widać drogi karawan",
  "graphics_setting.rail_distance_label": "Zasięg rysowania dróg",
  "graphics_setting.rail_thickness_desc": "Jak szeroko rysowane są drogi",
  "graphics_setting.rail_thickness_label": "Szerokość dróg",
  ...
  "public_game_modifier.sams_disabled": "Wieże antymagiczne wyłączone",
  "public_game_modifier.sams_disabled_label": "Wieże antymagiczne",
