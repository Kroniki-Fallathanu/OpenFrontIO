...
export class TribeSpawner {
  ...
  private randomTribeName(): string {
    ...
    // Fall back to theme-based prefix + suffix names. Hexah's own maps carry
    // the "hexah" theme, so their bands read as Polish dark-fantasy warbands
    // instead of historical civilisations.
